defmodule KapselistudioWeb.Router do
  use KapselistudioWeb, :router

  import KapselistudioWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {KapselistudioWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: KapselistudioWeb.Telemetry
    end
  end
  ...
  scope "/", KapselistudioWeb do
    ...
    live "/admin/users/new", AdminLive.Index, :new
    live "/admin/users/:id", AdminLive.Show, :show
