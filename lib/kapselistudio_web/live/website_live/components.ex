  ...
  def page(assigns) do
    ...
    <div class="body">
      <div class="sidebar bg-body-bg">
        <div class="p-8 flex flex-col text-secondary">
          <%= live_redirect(
            to:
